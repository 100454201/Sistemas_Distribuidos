...
int
_set_value_1 (SetModifyArgs  *argp, void *result, struct svc_req *rqstp)
{
	return (set_value_1_svc(*argp, result, rqstp));
}

int
_get_value_1 (char * *argp, void *result, struct svc_req *rqstp)
{
	return (get_value_1_svc(*argp, result, rqstp));
}

int
_modify_value_1 (SetModifyArgs  *argp, void *result, struct svc_req *rqstp)
{
	return (modify_value_1_svc(*argp, result, rqstp));
}

int
_delete_key_1 (char * *argp, void *result, struct svc_req *rqstp)
{
	return (delete_key_1_svc(*argp, result, rqstp));
}

int
_exist_1 (char * *argp, void *result, struct svc_req *rqstp)
{
...
{
	union {
		SetModifyArgs set_value_1_arg;
		char *get_value_1_arg;
		SetModifyArgs modify_value_1_arg;
	...
	union {
		int destroy_1_res;
		int set_value_1_res;
		GetValueResult get_value_1_res;
	...
	case SET_VALUE:
		_xdr_argument = (xdrproc_t) xdr_SetModifyArgs;
		_xdr_result = (xdrproc_t) xdr_int;
	...
	case GET_VALUE:
		...
		_xdr_result = (xdrproc_t) xdr_GetValueResult;
